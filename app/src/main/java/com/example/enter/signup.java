...
public class signup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            Intent intent3 = new Intent(signup.this, com.example.enter.MainActivity.class);
            ...
            public void onClick(View view) {
                ...
                if(edittext1.getText().toString()==""){
                    Toast toast1 =  Toast.makeText(signup.this, "請輸入帳號", Toast.LENGTH_SHORT);
                    toast1.setGravity(Gravity.BOTTOM|Gravity.CENTER,0,0);   //靠中下
                    toast1.show();
                }else if(edittext2.getText().toString()==""){
                    Toast toast2 =  Toast.makeText(signup.this, "請輸入密碼", Toast.LENGTH_SHORT);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////註冊密碼丟給登入頁面
                        ...
                        Toast toast3 =  Toast.makeText(signup.this, "註冊成功", Toast.LENGTH_SHORT);
...
*/
                        ...
                        Toast toast1 =  Toast.makeText(signup.this, "確認密碼錯誤", Toast.LENGTH_SHORT);
                        toast1.setGravity(Gravity.BOTTOM|Gravity.CENTER,0,0);   //靠中下
                        toast1.show();
                    }
                }
