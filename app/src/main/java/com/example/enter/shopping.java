...
public class shopping extends AppCompatActivity {
    ...
    public class MyAdapter extends BaseAdapter{
        ...
        private shopping.Data[] data;       //保存在myAdapter之中的資料來源
        private int view;                       //保存在myAdapter之中的畫面
        public MyAdapter(shopping.Data[] data,int view){
            this.data = data;
            this.view = view;
        }
        @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_addtocart.setOnClickListener(new View.OnClickListener() {
           ...
           //     Intent intent23 = new Intent(shopping.this, MainActivity3.class);
               ...
               // startActivity(intent23);
                ...
                //toast display
                Toast toast =  Toast.makeText(shopping.this, "已加入購物車", Toast.LENGTH_SHORT);
        ...
        shopping.Data[] cubeeData = new shopping.Data[cubeeNameArray.length];
        for(int i=0;i<cubeeData.length;i++){
            cubeeData[i] = new shopping.Data();
            cubeeData[i].name = cubeeNameArray[i];
            cubeeData[i].photo = cubeePhotoIdArray[i];
        }
        shopping.MyAdapter cubeeAdapter =new shopping.MyAdapter(cubeeData,R.layout.cubee_list);
